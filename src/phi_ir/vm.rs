...
use crate::phi_ir::{BlockId, Operand, PhiIRBinOp, PhiIRValue, ResonateDirection};
...
mod tests {
    ...
    use crate::phi_ir::{
        emitter,
        PhiIRBlock, PhiIRNode, PhiIRProgram, PhiIRValue, PhiInstruction, ResonateDirection,
    };
