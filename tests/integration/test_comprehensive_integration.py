...
try:
    ...
    pytestmark = pytest.mark.skip(
        reason="integration modules missing from src/integration"
    )
    RustPythonBridge = Mock
    QuantumCircuitResult = Mock
    ConsciousnessMetrics = Mock
    CUDAConsciousnessBridge = Mock
    ConsciousnessState = Mock
    CUDAPerformanceMetrics = Mock
    QuantumBackendIntegration = Mock
    QuantumCircuit = Mock
    QuantumExecutionResult = Mock
    ConsciousnessEEGPipeline = Mock
    ConsciousnessAnalysisResult = Mock
    ConsciousnessProcessingConfig = Mock
    PhiFlowIntegrationEngine = Mock
    IntegrationState = Mock
    IntegrationCommand = Mock
