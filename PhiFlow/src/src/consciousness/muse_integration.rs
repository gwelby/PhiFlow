...
impl MuseIntegration {
    ...
    pub async fn initialize(&mut self) -> Result<()> {
        ...
        let child = AsyncCommand::new("python3")
            .arg(python_script)
            .arg("--phiflow-mode")
        ...
        let (command_tx, command_rx) = mpsc::channel::<ConsciousnessCommand>(100);
...
pub fn calculate_phi_resonance(freq1: f64, freq2: f64) -> f64 {
    ...
    // Return resonance strength (1.0 = perfect phi ratio)
    1.0 - phi_error.min(lambda_error) / PHI
}
