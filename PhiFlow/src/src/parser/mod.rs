...
impl PhiParser {
    ...
    fn parse_statement(&mut self) -> Result<PhiExpression, String> {
        match &self.current_token {
            ...
            | PhiToken::LeftParen
            | PhiToken::Minus
            | PhiToken::Not => self.parse_expression_statement(),
            _ => Err(format!(
    ...
    fn expect_identifier(&mut self) -> Result<String, String> {
        ...
        let result = match &self.current_token {
            ...
            // Allow all keywords to be used as identifiers
            ...
            PhiToken::SriYantra => Ok("sriyantra".to_string()),
